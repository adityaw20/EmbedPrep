/**
 * Real Interview Questions from Popular Sources
 * Companies: Qualcomm, Intel, NXP, Bosch, Texas Instruments, STMicroelectronics, etc.
 */

const realQuestions = [
  // C Programming - Real Interview Questions
  {
  ...
  // Communication Protocols - Real Questions
  {
  ...
  // Embedded Systems - Real Questions
  {
  ...
  // Microcontrollers - Real Questions
  {
